...
export const columns: ColumnDef<ReportPurchaseOrderByProduct>[] = [
  {
    accessorKey: "productName",
    header: "Tên sản phẩm",
    cell: ({ row }) => (
      <p className="capitalize">{row.getValue("productName")}</p>
    ),
  },
  {
    ...
    header: "Mã sản phẩm",
    cell: ({ row }) => (
      <p className="capitalize">{row.getValue("productCode")}</p>
    ),
  },
  {
    accessorKey: "_id",
...
type Props = {
  data: ReportPurchaseOrderByProduct[];
};

export default function ReportPurchaseOrderTable({ data }: Props) {
