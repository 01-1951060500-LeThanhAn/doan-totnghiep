...
export const columns: ColumnDef<ReportShipmentByPartner>[] = [
  {
...

  {
    ...
    header: "Tổng tiền hàng đã vận chuyển",
    cell: ({ row }) => (
...
type Props = {
  data: ReportShipmentByPartner[];
};

export default function ReportShipmentPartnerTable({ data }: Props) {
