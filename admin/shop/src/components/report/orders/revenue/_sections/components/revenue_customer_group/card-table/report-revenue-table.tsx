...
export const columns: ColumnDef<ReportRevenueByCustomerGroupData>[] = [
  {
    accessorKey: "_id",
    header: "Tên nhóm khách hàng",
    cell: ({ row }) => (
      <p className="capitalize text-blue-400 ">{row.getValue("_id")}</p>
    ),
  },

  {
    accessorKey: "totalQuantity",
    header: "SL hàng bán ra",
    cell: ({ row }) => (
...
type Props = {
  data: ReportRevenueByCustomerGroupData[];
};

export default function ReportRevenueCustomerGroupTable({ data }: Props) {
