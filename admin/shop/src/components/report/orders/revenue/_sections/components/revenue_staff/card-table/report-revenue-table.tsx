...
export const columns: ColumnDef<ReportRevenueByStaffData>[] = [
  {
...

  {
    ...
    header: "Tiền hàng",
    cell: ({ row }) => (
      <p className="capitalize">{formatPrice(row.getValue("total_price"))}</p>
    ),
  },
  {
    accessorKey: "total_price",
...
type Props = {
  data: ReportRevenueByStaffData[];
};

export default function ReportRevenueStaffTable({ data }: Props) {
