...
export const columns: ColumnDef<ReportRevenueByTimeTableData>[] = [
  {
    ...
    cell: ({ row }) => {
      ...
      return <p className="capitalize">{formattedDate}</p>;
    },
  },
  {
    accessorKey: "code",
...

  {
    ...
    cell: ({ row }) => (
      <p className="capitalize">{row.getValue("name_customer")}</p>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <p className="capitalize">{row.getValue("phone_customer")}</p>
    ),
  },
  ...
  },
  {
    ...
    header: "SL đơn hàng",
    cell: ({ row }) => (
      <p className="capitalize">{row.getValue("totalOrder")}</p>
    ),
  },
  {
...
type Props = {
  data: ReportRevenueByTimeTableData[];
};

export default function ReportRevenueByTimeTable({ data }: Props) {
