...
export const columns: ColumnDef<ReportRevenueByProductData>[] = [
  {
    accessorKey: "name_product",
    header: "Tên sản phẩm",
    cell: ({ row }) => (
      <p className="capitalize text-blue-400 ">
        {row.getValue("name_product")}
      </p>
    ),
  },
  {
...
type Props = {
  data: ReportRevenueByProductData[];
};

export default function ReportRevenueProductTable({ data }: Props) {
