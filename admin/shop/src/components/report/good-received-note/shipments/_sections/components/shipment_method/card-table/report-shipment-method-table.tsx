...
export const columns: ColumnDef<ReportWarehouseShipmentByMethod>[] = [
  {
...

  {
    ...
    header: "Tổng tiền nhập hàng đã thanh toán",
    cell: ({ row }) => (
      <p className="capitalize">
...
type Props = {
  data: ReportWarehouseShipmentByMethod[];
};

export default function ReportPaymentMethodTable({ data }: Props) {
