...
export const columns: ColumnDef<ReceiptSupplierTableProps>[] = [
  {
    accessorKey: "code",
    header: "Mã phiếu thu",
    cell: ({ row }) => (
      <Link
        to={`/dashboard/receipt_vouchers/suppliers/${row.getValue(
          "_id"
        )}/detail`}
      >
...
type Props = {
  data: ReceiptSupplierTableProps[];
};

export default function ReceiptSupplierTableData({ data }: Props) {
