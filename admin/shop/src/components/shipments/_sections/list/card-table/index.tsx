...
export const columns: ColumnDef<ShipmentsData>[] = [
  {
    accessorKey: "code",
    header: "Mã vận đơn",
    cell: ({ row }) => (
  ...
  },
  {
    accessorKey: "partner",
    header: "Tên ĐTVC",
    cell: ({ row }) => <p className="capitalize">{row.getValue("partner")}</p>,
  },
  {
...
export default function ShipmentsTableData({ data }: Props) {
