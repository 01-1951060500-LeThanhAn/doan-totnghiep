...
import { PurchaseOrdersDataTableProps } from "@/types/purchaseOrder";
...
export const columns: ColumnDef<PurchaseOrdersDataTableProps>[] = [
  {
    accessorKey: "code",
    header: "Mã đơn đặt",
    cell: ({ row }) => (
...
type Props = {
  data: PurchaseOrdersDataTableProps[];
};

export default function PurchaseOrderTableData({ data }: Props) {
