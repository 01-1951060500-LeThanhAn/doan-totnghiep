...
//   }
// }
const createShippets = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const shippings = new ShippingWarehouseModel_1.default(Object.assign({}, req.body));
    try {
        yield shippings.save();
