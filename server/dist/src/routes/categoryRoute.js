...
router.get(`/`, auth_1.verifyTokenAndAuthorization, categoryController_1.getCategoryProduct);
...
router.get(`/:id`, auth_1.verifyTokenAndAuthorization, categoryController_1.getDetailCategoryProduct);
